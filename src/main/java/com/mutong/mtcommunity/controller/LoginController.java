...
import static com.mutong.mtcommunity.utils.CommunityConstant.ACTIVATION_REPEAT;
import static com.mutong.mtcommunity.utils.CommunityConstant.ACTIVATION_SUCCESS;
...
public class LoginController {
    ...
    public String login(String email, String password, String code, Model model , HttpServletResponse response,HttpSession session){
        ...
        if (ObjectUtil.isEmpty(map) || ObjectUtil.isNull(map)){
            return "index";
        }else {
